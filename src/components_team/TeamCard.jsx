...
const TeamCard = ({
    ...
    return (
        <div className="relative w-[250px] h-[250px] lg:w-[295px] lg:h-[295px]  flex items-center justify-center">
            ...
            <div className="absolute left-[0] top-1/2 -translate-y-1/2 -translate-x-[45%] rotate-[-90deg] origin-center">
                <div className="flex flex-col items-start text-sm font-semibold lg:text-lg">
                    <span className="text-black">{name}</span>
                    <span className="text-[#FF7833]">{designation}</span>
                </div>
            </div>
